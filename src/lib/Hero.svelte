...
>
	<div>
		<h2
			class="text-3xl font-thin uppercase tracking-widest text-gray-900 sm:tracking-tight sm:text-4xl"
		>
		...
		<a href="#one" class="flex justify-center items-center"><IconDown /></a>
	</div>
</div>
